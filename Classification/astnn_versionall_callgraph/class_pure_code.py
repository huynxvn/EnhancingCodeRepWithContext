...
if __name__ == '__main__':
    ...
    print("Train for classification - PURE CODE - With BOTH VerAll Callgraph ")
    ...
    # store model result    
    model_log = "Neural Network-ASTNN-VersionAll_Callgraph-Class Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (acc, p, r, f, str_time2run)

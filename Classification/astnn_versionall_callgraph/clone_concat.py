...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CONCATENATE - With BOTH - Version All + Call Graph")
    ...
    # store model result    
    model_log = "Neural Network-ASTNN-VersionAll_Callgraph-Clone Concat, %.5f, %.5f, %.5f, %.5f, %s" % (acc, p, r, f, str_time2run)

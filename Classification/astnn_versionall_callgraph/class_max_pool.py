...
class BatchProgramClassifier(nn.Module):
    ...
    # def forward(self, x1, x3, x4):
        ...
        inputs = torch.cat([code, code_versions_all, calling, called], dim=0)        
...
if __name__ == '__main__':
    ...
    print("Train for classification - MAX POOL - With BOTH VerAll Callgraph")
    ...
    # store model result    
    model_log = "Neural Network-ASTNN-VersionAll_Callgraph-Class Max Pool, %.5f, %.5f, %.5f, %.5f, %s" % (acc, p, r, f, str_time2run)

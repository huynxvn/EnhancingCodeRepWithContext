...
if __name__ == '__main__':
    ...
    print("Train for clone detection - PURE CODE - With VERSION HISTORY ALL ")
    ...
    for epoch in range(EPOCHS):
        ...
        while i < len(train_data):
            ...
            # output = model(train_code_x, train_code_y)
        ...
        while i < len(dev_data):
            ...
            i += BATCH_SIZE
            # dev_code_x, dev_code_y, dev_labels = batch
            ...
            # output = model(dev_code_x, dev_code_y)
    ...
    while i < len(test_data):
        ...
        i += BATCH_SIZE
        # test_code_x, test_code_y, test_labels = batch
        ...
        # output = model(test_code_x, test_code_y)
    ...
    # store model result    
    model_log = "Neural Network-ASTNN-VersionAll-Clone Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (acc, p, r, f, str_time2run)

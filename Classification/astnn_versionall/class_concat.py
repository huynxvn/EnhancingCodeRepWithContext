...
if __name__ == '__main__':
    ...
    print("Train for classification - CONCAT - With VERSION HISTORY ALL")
    ...
    # store model result    
    model_log = "Neural Network-ASTNN-VersionAll-Class Concat, %.5f, %.5f, %.5f, %.5f, %s" % (acc, p, r, f, str_time2run)

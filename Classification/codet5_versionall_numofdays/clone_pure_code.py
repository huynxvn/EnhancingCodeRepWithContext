...
if __name__ == '__main__':
    ...
    print(f"Train for clone detection - {p_model} - with VERSION ALL and NUM OF DAYS - Clone Pure Code ")
    ...
    model_log = "Transformer-%s-VersionAll_NumOfDays-Clone Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

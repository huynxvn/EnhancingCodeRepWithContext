...
class BatchProgramClassifier(nn.Module):
    def __init__(self,
        ...
        self.hidden2label = nn.Linear(self.hidden_dim * 3 + 3, self.label_size)
...
if __name__ == '__main__':
    ...
    print(f"Train for clone detection - {p_model} with VERSION ALL and NUM OF DAYS - Clone Diff Concat")
    ...
    model_log = "Transformer-%s-VersionAll_NumOfDays-Clone Diff Concat, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

...
class CodeCloneDataset(Dataset):
    def __init__(self, 
        ...
        self.save_dir = f"./data/clone_detection/processed_callgraph_v1/{data_type}/"
    ...
    def extract_features(self,
        ...
        calling_x               = js['t_calling_v1_x']
        called_x                = js['t_called_v1_x']
        ...
        calling_y               = js['t_calling_v1_y']
        called_y                = js['t_called_v1_y']

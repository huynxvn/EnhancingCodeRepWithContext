...
# # # codeberta
# python -u transformer_versionall/clone_pure_code.py --model codeberta
# python -u transformer_versionall/clone_concat.py --model codeberta
# python -u transformer_versionall/clone_max_pool.py --model codeberta
# python -u transformer_versionall/clone_diff_concat.py --model codeberta

# # python -u transformer_callgraph/clone_pure_code.py --model codeberta 
# python -u transformer_callgraph/clone_concat.py --model codeberta 
# python -u transformer_callgraph/clone_max_pool.py --model codeberta 
# python -u transformer_callgraph/clone_diff_concat.py --model codeberta

# # python -u transformer_versionall_callgraph/clone_pure_code.py --model codeberta 
# python -u transformer_versionall_callgraph/clone_concat.py --model codeberta 
# python -u transformer_versionall_callgraph/clone_max_pool.py --model codeberta 
# python -u transformer_versionall_callgraph/clone_diff_concat.py --model codeberta

# # python -u transformer_versionall_numofdays/clone_pure_code.py --model codeberta 
# python -u transformer_versionall_numofdays/clone_concat.py --model codeberta 
# python -u transformer_versionall_numofdays/clone_max_pool.py --model codeberta 
# python -u transformer_versionall_numofdays/clone_diff_concat.py --model codeberta

# # python -u transformer_versionall_callgraph_numofdays/clone_pure_code.py --model codeberta 
# python -u transformer_versionall_callgraph_numofdays/clone_concat.py --model codeberta 
# python -u transformer_versionall_callgraph_numofdays/clone_max_pool.py --model codeberta 
# python -u transformer_versionall_callgraph_numofdays/clone_diff_concat.py --model codeberta
...
# # # codet5p110membedding 

# python -u codet5_versionall/clone_pure_code.py --model codet5p110membedding
# python -u codet5_versionall/clone_concat.py --model codet5p110membedding
# python -u codet5_versionall/clone_max_pool.py --model codet5p110membedding
# python -u codet5_versionall/clone_diff_concat.py --model codet5p110membedding

# # python -u codet5_callgraph/clone_pure_code.py --model codet5p110membedding 
# python -u codet5_callgraph/clone_concat.py --model codet5p110membedding 
# python -u codet5_callgraph/clone_max_pool.py --model codet5p110membedding 
# python -u codet5_callgraph/clone_diff_concat.py --model codet5p110membedding

# # python -u codet5_versionall_callgraph/clone_pure_code.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph/clone_concat.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph/clone_max_pool.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph/clone_diff_concat.py --model codet5p110membedding

# # python -u codet5_versionall_numofdays/clone_pure_code.py --model codet5base 
# python -u codet5_versionall_numofdays/clone_concat.py --model codet5p110membedding 
# python -u codet5_versionall_numofdays/clone_max_pool.py --model codet5p110membedding 
# python -u codet5_versionall_numofdays/clone_diff_concat.py --model codet5p110membedding

# # python -u codet5_versionall_callgraph_numofdays/clone_pure_code.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph_numofdays/clone_concat.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph_numofdays/clone_max_pool.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph_numofdays/clone_diff_concat.py --model codet5p110membedding
...
# # # codeberta
# python -u transformer_versionall/class_pure_code.py --model codeberta
# python -u transformer_versionall/class_concat.py --model codeberta 
# python -u transformer_versionall/class_max_pool.py --model codeberta

# # python -u transformer_callgraph/class_pure_code.py --model codeberta 
# python -u transformer_callgraph/class_concat.py --model codeberta
# python -u transformer_callgraph/class_max_pool.py --model codeberta 

# # python -u transformer_versionall_callgraph/class_pure_code.py --model codeberta 
# python -u transformer_versionall_callgraph/class_concat.py --model codeberta 
# python -u transformer_versionall_callgraph/class_max_pool.py --model codeberta 

# # python -u transformer_versionall_numofdays/class_pure_code.py --model codeberta 
# python -u transformer_versionall_numofdays/class_concat.py --model codeberta 
# python -u transformer_versionall_numofdays/class_max_pool.py --model codeberta 

# # python -u transformer_versionall_callgraph_numofdays/class_pure_code.py --model codeberta 
# python -u transformer_versionall_callgraph_numofdays/class_concat.py --model codeberta 
# python -u transformer_versionall_callgraph_numofdays/class_max_pool.py --model codeberta
...
# # # codet5p110membedding
# python -u codet5_versionall/class_pure_code.py --model codet5p110membedding
# python -u codet5_versionall/class_concat.py --model codet5p110membedding 
# python -u codet5_versionall/class_max_pool.py --model codet5p110membedding

# # python -u codet5_callgraph/class_pure_code.py --model codet5p110membedding 
# python -u codet5_callgraph/class_concat.py --model codet5p110membedding
# python -u codet5_callgraph/class_max_pool.py --model codet5p110membedding 

# # python -u codet5_versionall_callgraph/class_pure_code.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph/class_concat.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph/class_max_pool.py --model codet5p110membedding 

# # python -u codet5_versionall_numofdays/class_pure_code.py --model codet5p110membedding 
# python -u codet5_versionall_numofdays/class_concat.py --model codet5p110membedding 
# python -u codet5_versionall_numofdays/class_max_pool.py --model codet5p110membedding 

# # python -u codet5_versionall_callgraph_numofdays/class_pure_code.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph_numofdays/class_concat.py --model codet5p110membedding 
# python -u codet5_versionall_callgraph_numofdays/class_max_pool.py --model codet5p110membedding

...
class BatchProgramClassifier(nn.Module):
    ...
    def forward(self, x1=None, x2=None, x3=None, x4=None, x8=None, x9=None, x10=None, y1=None, y2=None, y3=None, y4=None, y8=None, y9=None, y10=None):
        ...
        lvec = lvec.view(3, self.batch_size, self.hidden_dim)
        rvec = rvec.view(3, self.batch_size, self.hidden_dim)
...
if __name__ == '__main__':
    ...
    print(f"Train for clone detection - {p_model} with CALLGRAPH - Clone Max Pool")
    ...
    model_log = "Transformer-%s-Callgraph-Clone Max Pool, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

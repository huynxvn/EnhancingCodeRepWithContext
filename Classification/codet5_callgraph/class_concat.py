...
if __name__ == '__main__':
    ...
    print(f"Train for classification - {p_model} - CONCAT - With CALLGRAPH ")
    ...
    # store model result    
    model_log = "Transformer-%s-CallGraph-Class Concat, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

...
if __name__ == '__main__':
    ...
    print(f"Train for clone detection - {p_model} with CALLGRAPH - Clone Concat ")
    ...
    model_log = "Transformer-%s-Callgraph-Clone ConCat, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

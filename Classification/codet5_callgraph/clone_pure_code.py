...
if __name__ == '__main__':
    ...
    print(f"Train for clone detection - {p_model} with VERSION HISTORY - Clone Pure Code ")
    ...
    model_log = "Transformer-%s-Callgraph-Clone Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

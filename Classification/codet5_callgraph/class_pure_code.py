...
if __name__ == '__main__':
    ...
    print(f"Train for classification - {p_model} - PURE CODE - With CALLGRAPH ")
    ...
    # store model result    
    model_log = "Transformer-%s-CallGraph-Class Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

...
if __name__ == '__main__':
    ...
    print(f"Train for clone detection - {p_model} with VERSION ALL - Clone Concat ")
    ...
    model_log = "Transformer-%s-VersionAll-Clone ConCat, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

...
if __name__ == '__main__':
    ...
    print(f"Train for classification - {p_model} - CONCAT - With VERSION ALL ")
    ...
    # store model result    
    model_log = "Transformer-%s-VersionAll-Class Concat, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

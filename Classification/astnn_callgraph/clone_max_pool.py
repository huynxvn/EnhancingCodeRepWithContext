...
if __name__ == '__main__':
    ...
    print("Train for clone detection - MAX POOLING - With CALLGRAPH ")
    ...
    # store model result    
    model_log = "Neural Network-ASTNN-CallGraph-Clone Max Pool, %.5f, %.5f, %.5f, %.5f, %s" % (acc, p, r, f, str_time2run)

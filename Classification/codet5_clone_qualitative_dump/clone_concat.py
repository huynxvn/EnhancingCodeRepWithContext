...
p_model_save_dir = exp_setting["model_save_dir"] + "/clone_qualitative_dump"
if p_task == "clone":
    ...
    for batch in test_loader:
        ...
        for idx in range(len(predicted)):
            ...
            per_pair_records.append({
                ...
                "calling_x": str(row.get('t_calling_x', '')),
                "calling_y": str(row.get('t_calling_y', '')),
                "called_x": str(row.get('t_called_x', '')),
                "called_y": str(row.get('t_called_y', '')),

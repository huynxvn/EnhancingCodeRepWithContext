...
if __name__ == '__main__':
    ...
    print(f"Train for classification - {p_model} - PURE CODE - With VERSION ALL + CALLGRAPH ")
    ...
    # store model result    
    model_log = "Transformer-%s-VersionAll_CallGraph-Class Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)

...
if __name__ == '__main__':
    ...
    print(f"Train for classification - {p_model} - PURE CODE - With VERSIONALL + CALLGRAPH + NUMOFDAYS ")
    ...
    # store model result    
    model_log = "Transformer-%s-VersionAll_CallGraph_NumOfDays-Class Pure Code, %.5f, %.5f, %.5f, %.5f, %s" % (p_model, acc, p, r, f, str_time2run)
